      ...
      <div className="container mx-auto py-10">
            ...
            <Droppable droppableId="Done">
              {(provided) => (
                <div
                  ...
                  className="bg-secondary rounded p-4 min-h-[300px]"
                >
                  <h2 className="text-lg font-semibold mb-4">Done <Check className="inline-block text-accent h-5 w-5 ml-1" /></h2>
        ...
        {!isCreateFormOpen ? (
          <div className="text-center mt-8">
            <Button onClick={() => setIsCreateFormOpen(true)}><PlusCircle className="mr-2 h-4 w-4" /> Add New Task</Button>
          </div>
        ) : (
          <Card className="mt-8">
            <CardHeader>
            ...
            <CardContent className="grid gap-4">
              <div className="grid gap-2">
                <label htmlFor="newTaskTitle" className="text-sm font-medium">Title</label>
                <Input
                  type="text"
                  id="newTaskTitle"
                  value={newTaskTitle}
              ...
              <div className="grid gap-2">
                <label htmlFor="newTaskDescription" className="text-sm font-medium">Description</label>
                <Textarea
            ...
            <CardFooter className="flex justify-end gap-2">
              <Button variant="secondary" onClick={() => setIsCreateFormOpen(false)}>Cancel</Button>
